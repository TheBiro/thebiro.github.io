function plotOv3() {
    ...
    var svg = d3.select("#ov_chart_3").append("svg");

    var g = svg.append("g");

    var div = d3.select("#ov_chart_3").append("div").attr("class", "toolTip");
    ...
    //////// READ FILE ////////
    d3.csv("data/overview/overview_3.csv", function(error, data) {
    ...
    function update() {
    	...
    	var chartDim = document.getElementById("ov_chart_3");
