function plotOv4() {
    ...
    var div = d3.select("#ov_chart_4").append("div").attr("class", "toolTip");
    ...
    //////// READ FILE ////////
    d3.csv("data/overview/overview_4.csv", function(error, data) {
    ...
    function update() {
    	...
    	var chartDim = document.getElementById("ov_chart_4");
