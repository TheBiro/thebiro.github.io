...
var chartDim = document.getElementById("chart_sankey_15");

var svg = d3.select("#chart_sankey_15").append("svg");
// Dimensionss
var w = chartDim.clientWidth;
var h = chartDim.clientHeight;
	...
	// add in the title for the nodes
 	node.append("text")
		...
		.filter(function(d) { return d.x < 1; })
			.style("font-size", function(d) { return 0.9*textScale(d.value); })
